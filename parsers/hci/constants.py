...
HCI_COMMANDS = {
    ...
    (0x01, 0x0019): "Remote Name Request", (0x01, 0x001D): "Read RSSI", (0x01, 0x001B): "Read Remote Supported Features",
    (0x02, 0x0009): "Role Discovery",
    (0x02, 0x000D): "Write Link Policy Settings", (0x02, 0x000F): "Write Default Link Policy Settings",
